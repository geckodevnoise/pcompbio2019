...
%edited on May 18th to also output 
%the cut disk diameter to SS ratio

%Peak Length is calculated on the Convex Hull of the image
%SS and PL are given in inches

function [PL,SS,EE,FA,diameter_ratio]=pattern_stats_GeckoBinary_May18_2017(gecko,f);
cd ..
...
d=regionprops(binary_imageROI,'EquivDiameter');
d.EquivDiameter

diameter_ratio=d.EquivDiameter/SS
