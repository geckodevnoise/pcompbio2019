...
distance_grid_682b=zeros(size(vary_fu_g,2),size(vary_FT_g,2));
...
for i=1:size(vary_fu_g,2)
    ...
    for j=1:size(vary_FT_g,2)
        ...
        fu_grid(i,j)=fu_g;
        FT_grid(i,j)=FT_g;
        [cEE,cFA,nFA,nEE,percent_distance]=distance_from_phenotype_center_Dec23(fu_g,FT_g,682);
        distance_grid_682b(i,j)=percent_distance;
    end
end
