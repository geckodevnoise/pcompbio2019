...
light_red=[distance_grid_731<outer].*(red==0);
own_jpeg(:,:,1)=own_jpeg(:,:,1)+red*255+light_red*255;
own_jpeg(:,:,2)=own_jpeg(:,:,2)+light_red*k;
own_jpeg(:,:,3)=own_jpeg(:,:,3)+light_red*k;
%blue and light blue
blue=[distance_grid_763<50];
light_blue=[distance_grid_763<outer].*(blue==0);
own_jpeg(:,:,3)=own_jpeg(:,:,3)+blue*255+light_blue*255;
own_jpeg(:,:,2)=own_jpeg(:,:,2)+light_blue*k;
own_jpeg(:,:,1)=own_jpeg(:,:,1)+light_blue*k;
%white
