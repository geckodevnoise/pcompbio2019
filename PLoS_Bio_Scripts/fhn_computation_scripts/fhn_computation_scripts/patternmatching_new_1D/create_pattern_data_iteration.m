...
%     optd=dlist(k);
        ...
        gecko_dir=[ num2str(gecko_id) '_TolFun0.0001_TolX0.0001_MaxIter60'];
   

load([gecko_dir '/optimization_results.mat'], 'optimal_param', 'inid','mindist','threshold');


optrho=optimal_param(1);
optR=optimal_param(2);
optd=inid;
...
%save([gecko_dir '/optimization_results.mat'], 'optimal_param', 'inid','mindist','threshold');
